-- Harden the provider conversation RPC against search_path shadowing.
-- This additive migration preserves the existing authorization and marketplace checks
-- while switching the SECURITY DEFINER function to an empty search_path.

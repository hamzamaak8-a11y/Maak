...
const DICTS: Record<Lang, Record<string,string>> = { ar: { ...ar, ...adminAr, ...bookingErrorAr, ...chatAr, ...availabilityAr, ...reviewsAr, ...notificationsAr, ...providerDashboardAr }, fr: { ...fr, ...adminFr, ...bookingErrorFr, ...chatFr, ...availabilityFr, ...reviewsFr, ...notificationsFr, ...providerDashboardFr } };

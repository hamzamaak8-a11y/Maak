...
const DICTS: Record<Lang, Record<string,string>> = { ar: { ...ar, ...adminAr, ...bookingErrorAr, ...chatAr, ...availabilityAr, ...reviewsAr, ...notificationsAr, ...providerDashboardAr, ...financialAr, ...searchAr, ...customerAr, ...providerDetailAr, ...providerServicesAr, ...providerPortfolioAr, ...providerSubscriptionAr }, fr: { ...fr, ...adminFr, ...bookingErrorFr, ...chatFr, ...availabilityFr, ...reviewsFr, ...notificationsFr, ...providerDashboardFr, ...financialFr, ...searchFr, ...customerFr, ...providerDetailFr, ...providerServicesFr, ...providerPortfolioFr, ...providerSubscriptionFr } };

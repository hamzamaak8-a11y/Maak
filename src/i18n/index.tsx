...
import { reviewsAr, reviewsFr } from "./reviews";
import { notificationsAr, notificationsFr } from "./notifications";
import { providerDashboardAr, providerDashboardFr } from "./provider-dashboard";
import { financialAr, financialFr } from "./financial";
import { searchAr, searchFr } from "./search";
import { customerAr, customerFr } from "./customer";
import { providerDetailAr, providerDetailFr } from "./provider-detail";
import { providerServicesAr, providerServicesFr } from "./provider-services";
import { providerPortfolioAr, providerPortfolioFr } from "./provider-portfolio";
import { providerSubscriptionAr, providerSubscriptionFr } from "./provider-subscription";
import { featuredAr, featuredFr } from "./featured";
import { v2Ar, v2Fr } from "./v2";
export type Lang = "ar" | "fr";
export type Dir = "rtl" | "ltr";
const STORAGE_KEY = "maak:lang:v2";
const DICTS: Record<Lang, Record<string,string>> = { ar: { ...ar, ...adminAr, ...bookingErrorAr, ...chatAr, ...availabilityAr, ...reviewsAr, ...notificationsAr, ...providerDashboardAr, ...financialAr, ...searchAr, ...customerAr, ...providerDetailAr, ...providerServicesAr, ...providerPortfolioAr, ...providerSubscriptionAr, ...featuredAr, ...v2Ar }, fr: { ...fr, ...adminFr, ...bookingErrorFr, ...chatFr, ...availabilityFr, ...reviewsFr, ...notificationsFr, ...providerDashboardFr, ...financialFr, ...searchFr, ...customerFr, ...providerDetailFr, ...providerServicesFr, ...providerPortfolioFr, ...providerSubscriptionFr, ...featuredFr, ...v2Fr } };
...
function readInitialLang():Lang{try{const stored=localStorage.getItem(STORAGE_KEY);if(stored==="fr"||stored==="ar")return stored;}catch{}return"ar";}

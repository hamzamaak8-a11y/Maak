...
const DICTS: Record<Lang, Record<string,string>> = { ar: { ...ar, ...adminAr, ...bookingErrorAr, ...chatAr, ...availabilityAr, ...reviewsAr }, fr: { ...fr, ...adminFr, ...bookingErrorFr, ...chatFr, ...availabilityFr, ...reviewsFr } };

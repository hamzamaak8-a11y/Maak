...
const DICTS: Record<Lang, Record<string,string>> = { ar: { ...ar, ...adminAr, ...bookingErrorAr, ...chatAr, ...availabilityAr, ...reviewsAr, ...notificationsAr }, fr: { ...fr, ...adminFr, ...bookingErrorFr, ...chatFr, ...availabilityFr, ...reviewsFr, ...notificationsFr } };

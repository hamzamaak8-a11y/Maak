...
export type BookingRow = {
  ...
  service_category: string; service_description: string; service_date: string | null; location_text: string | null;
...
export type Profile = {
  id: string; role: Role; full_name: string | null; phone: string | null; city: string | null;
  avatar_url: string | null; account_status: AccountStatus; created_at: string; updated_at: string;
};
...
export type ProviderProfile = {
  ...
  experience_years: number | null; services: string[] | null; price_from: number | null; service_radius_km: number | null;
  profile_photo_public: boolean; verification_status: VerificationStatus; rejection_reason: string | null;

...
function AppSplash() { const { t } = useLanguage(); return <div className="maak-splash" aria-label={t("common.loading")}><MaakMark size={48}/><Loader2 className="spin" size={20}/></div>; }
